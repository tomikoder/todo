...
RUN apt update -y && apt upgrade -y && \
    ...
    apt install -y php8.2 && apt-get install -y php8.2-curl php8.2-mysql php8.2-common  php8.2-bcmath \
    php8.2-gd php8.2-intl php8.2-mbstring php8.2-opcache php8.2-xml php8.2-zip php8.2-dev php8.2-apcu && \
    apt-get install -y curl && apt-get install -y libmcrypt-dev && apt-get install php8.2-fpm -y && apt install nginx -y && apt install git -y
